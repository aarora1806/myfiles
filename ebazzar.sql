...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2018 at 07:20 PM
...
INSERT INTO `products` (`product_id`, `user_id`, `prod_name`, `Category`, `prod_description`, `Price`, `admin_approval`, `Product_status`) VALUES
(1, 0, 'horlicks', '', '', 0, 0, 'unsold'),
(2, 0, 'Honda Scooter', '', '', 0, 0, 'unsold'),
(3, 0, 'Hero Cycle', '', '', 0, 0, 'sold'),
(4, 0, 'HP Computer', '', '', 0, 0, 'sold');
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `College-ID`, `phone_number`, `pwd`, `dob`, `reg_date`, `last_active`, `last_ip`, `last_ip_proxy`, `gender`, `type`, `hash`, `email_verified`, `admin_approved`) VALUES
